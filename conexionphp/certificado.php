...
$sql="SELECT distinct
    id, nombres,
    min(fecha),
    sum(valor_a_ahorrar)- sum(valor_a_retirar) as saldo
FROM 
    ahorros a
INNER JOIN 
...
<p>Posee sus ahorros en nuestro sistema desde la fecha '.$mostrar['min(fecha)'].', con un saldo a favor de <strong>$'.number_format($mostrar['saldo'],1).'</strong> pesos M/CTE</p>
